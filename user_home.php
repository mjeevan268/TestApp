		...
		<div class="container">
			...
			<div id="test" class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a id="test" href="donateus">Donate</a></li>
					<li><a id="test" href="contactus">Contact Us</a></li>
				</ul>
				<!--Login/Rgeister-->
				<p style="color:white;left:1000px;position:absolute;top:8px;">
				<!--<a href="#register">Register</a>/<a href="#login">Login</a>-->
                                Logged In,<?php echo $_SESSION['firstname'];?>
                               &nbsp;</p>
			</div><!-- /.navbar-collapse -->
		</div><!-- /.container -->
		</nav>
			...
			<div class="maincontent">
				<div id="apDiv1">
					<h1>Welcome <?php echo $_SESSION['firstname'];?></h1>
                                        ...
                                        <div style="background-color:white;height:300px;width:800px;float:left;padding:10px 10px 10px 10px">
                                        <h4 id="font4" style="padding:10px 10px 10px 10px;"> You can now Search for a bloodgroup that you need which mathces with our members in the place nearer to you... </h4>
                                        
                                         <a href="searchblood.php"><button>Search Blood Group</button></a>                                        </div>
                                         <div style="float:right;height:300px;width:300px;"><img src="bloodimage.jpg" style="height:300px;width:300px;float:right">
                           </div>
					<!--<a href="searchblood.php"><button>Search Blood Group</button></a>-->
                               ...
                               <!-- <div style="background-color:white" id="ambasadors">
                                      <p>You can check out the ambasaadors list here !!! </p>
                                      <button>Ambassadors Blog</button>
                 
                                </div>-->
               
                                 <h2 id="font1">  WebSite is Under Construction !!! :D </h2>
                                    </center>
