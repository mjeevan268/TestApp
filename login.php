...
if($_GET['loginFailed']) {
	...
	else if($reason == "nopassword") {
		echo "<script type=\"text/javascript\">
		alert('Please enter a password.');
		</script>";
	}
	else if($reason == "norecord") {
		echo "<script type=\"text/javascript\">
		alert('Sorry, email and password do not match.');
		</script>";
	}
}
?>
	...
	<body>
		...
		<div class="body">
			<div class="maincontent">
				<div id="apDiv1">
					<form id="register" method="post" action="checklogin.php">
						<table>
							<tr>
								<td>Email-id:</td>
